...
一套「spec → plan → build → review → compound」的具体工程流水线：既有方法（各阶段子技能），也有功能（真实 CLI + 落盘产物）。融合 superpowers、spec-kit、OpenSpec、agent-os、compound-engineering、gstack、ECC、karpathy、mattpocock、agency-agents、scientific-agent-skills 十余个项目之所长。
